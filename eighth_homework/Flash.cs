...
namespace eighth_homework
{
	...
	{
		public int SpeedThreeUSB { set; get; } = 5000;// 5 Гб/сек

		public Flash(string name, string model)
		{
			Name = name;
			Model = model;
			FullMemory = 7000;
		...
		{
			base.GetFullInfo();
			WriteLine($"Speed : {SpeedThreeUSB} MB/Sec");
			WriteLine($"\nActual time for copying with this speed: {TransportingMemory / SpeedThreeUSB} sec");
		}
